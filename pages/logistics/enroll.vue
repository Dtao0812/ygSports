	...
	<view class="content">
		<view class="grace-form">
			<form @submit="formSubmit">
						...
						<view class="uni-common-mt">
							<view class="uni-form-item uni-column">
								<view class="with-fun">
									...
									<input class="uni-input" type="text" placeholder="物流公司名称" name="logisticsName" placeholder-style="color:#aaaaaa" />
								</view>
							</view>
						</view>
						<view class="uni-common-mt">
						...
						<view class="uni-common-mt">
							<view class="uni-form-item uni-column">
								<view class="with-fun">
									...
									<input class="uni-input" type="text" placeholder="物流公司人数" name="bz2" placeholder-style="color:#aaaaaa" />
								</view>
							</view>
						</view>
					</view>
				...
				<view class="form-box">
					<view class="form-box-title">物流公司照片</view>
				...
				<view class="form-box">
					<view class="form-box-title">物流公司介绍</view>
					<view class="form-content">
						<view class="uni-textarea">
							<textarea placeholder-style="color:#b4b4b4;" name="introduce" placeholder="请尽可能介绍物流公司货运经验和货运案例.限制400字" auto-height />
						</view>
	...
	export default {
		...
		methods:{
			...
			formSubmit : function(e){
				//定义表单规则
				var rule = [
					{name:"logisticsName", checkType : "string",errorMsg:"请输入名称"},
					{name:"attention", checkType : "string",errorMsg:"请输入联系人"},
					{name:"bz2", checkType : "string",errorMsg:"请输入人数"},
					{name:"tel", checkType : "string",errorMsg:"请输入联系方式"},
					{name:"introduce", checkType : "string",errorMsg:"请输入介绍"},
				...
				if(checkRes){
					let reqInfo = {};
					reqInfo.logisticsName = this.logisticsName;
